...
namespace LineOpenApi.Webhook.Model
{
    ...
    public partial class UnsendEvent : Event, IEquatable<UnsendEvent>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as UnsendEvent);
        }

        /// <summary>
        /// Returns true if UnsendEvent instances are equal
        /// </summary>
        /// <param name="input">Instance of UnsendEvent to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UnsendEvent input)
        {
            if (input == null)
            {
                return false;
            ...
            return base.Equals(input) && 
                (
                    this.Unsend == input.Unsend ||
                    (this.Unsend != null &&
                    this.Unsend.Equals(input.Unsend))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.Unsend != null)
                {
                    hashCode = (hashCode * 59) + this.Unsend.GetHashCode();
                }
                return hashCode;
            }
        }
