...
namespace LineOpenApi.Webhook.Model
{
    ...
    public partial class ModuleContent : IEquatable<ModuleContent>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as ModuleContent);
        }

        /// <summary>
        /// Returns true if ModuleContent instances are equal
        /// </summary>
        /// <param name="input">Instance of ModuleContent to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ModuleContent input)
        {
            if (input == null)
            {
                return false;
