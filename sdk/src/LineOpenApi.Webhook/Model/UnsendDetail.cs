...
namespace LineOpenApi.Webhook.Model
{
    ...
    public partial class UnsendDetail : IEquatable<UnsendDetail>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as UnsendDetail);
        }

        /// <summary>
        /// Returns true if UnsendDetail instances are equal
        /// </summary>
        /// <param name="input">Instance of UnsendDetail to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UnsendDetail input)
        {
            if (input == null)
            {
                return false;
