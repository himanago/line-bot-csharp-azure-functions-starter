...
namespace LineOpenApi.Webhook.Model
{
    ...
    public partial class ImageMessageContent : MessageContent, IEquatable<ImageMessageContent>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as ImageMessageContent);
        }

        /// <summary>
        /// Returns true if ImageMessageContent instances are equal
        /// </summary>
        /// <param name="input">Instance of ImageMessageContent to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ImageMessageContent input)
        {
            if (input == null)
            {
                return false;
            ...
            return base.Equals(input) && 
                ...
                (
                    this.ImageSet == input.ImageSet ||
                    (this.ImageSet != null &&
                    this.ImageSet.Equals(input.ImageSet))
                ) && base.Equals(input) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                {
                    hashCode = (hashCode * 59) + this.ImageSet.GetHashCode();
                }
