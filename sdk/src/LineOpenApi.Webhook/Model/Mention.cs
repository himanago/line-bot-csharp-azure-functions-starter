...
namespace LineOpenApi.Webhook.Model
{
    ...
    public partial class Mention : IEquatable<Mention>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as Mention);
        }

        /// <summary>
        /// Returns true if Mention instances are equal
        /// </summary>
        /// <param name="input">Instance of Mention to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Mention input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                (
                    this.Mentionees == input.Mentionees ||
                    this.Mentionees != null &&
                    input.Mentionees != null &&
                    this.Mentionees.SequenceEqual(input.Mentionees)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                {
                    hashCode = (hashCode * 59) + this.Mentionees.GetHashCode();
                }
                return hashCode;
            }
        }
