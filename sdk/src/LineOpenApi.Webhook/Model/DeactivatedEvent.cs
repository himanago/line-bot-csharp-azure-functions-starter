...
namespace LineOpenApi.Webhook.Model
{
    ...
    public partial class DeactivatedEvent : Event, IEquatable<DeactivatedEvent>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DeactivatedEvent" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DeactivatedEvent() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DeactivatedEvent" /> class.
        /// </summary>
        /// <param name="type">Type of the event (required) (default to &quot;DeactivatedEvent&quot;).</param>
        ...
        public DeactivatedEvent(string type = @"DeactivatedEvent", Source source = default(Source), long timestamp = default(long), EventMode mode = default(EventMode), string webhookEventId = default(string), DeliveryContext deliveryContext = default(DeliveryContext)) : base(type, source, timestamp, mode, webhookEventId, deliveryContext)
        {
        }
        ...
        {
            return this.Equals(input as DeactivatedEvent);
        }

        /// <summary>
        /// Returns true if DeactivatedEvent instances are equal
        /// </summary>
        /// <param name="input">Instance of DeactivatedEvent to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DeactivatedEvent input)
        {
            if (input == null)
            {
                return false;
