...
namespace LineOpenApi.MessagingApi.Model
{
    ...
    public partial class ImageMessage : Message, IEquatable<ImageMessage>, IValidatableObject
    {
        /// <summary>
        ...
        public ImageMessage(string originalContentUrl = default(string), string previewImageUrl = default(string), string type = @"image", QuickReply quickReply = default(QuickReply), Sender sender = default(Sender)) : base(type, quickReply, sender)
        {
        ...
        {
            return this.Equals(input as ImageMessage);
        }

        /// <summary>
        /// Returns true if ImageMessage instances are equal
        /// </summary>
        /// <param name="input">Instance of ImageMessage to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ImageMessage input)
        {
            if (input == null)
            {
                return false;
