...
namespace LineOpenApi.MessagingApi.Model
{
    ...
    public partial class GenderDemographicFilter : DemographicFilter, IEquatable<GenderDemographicFilter>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as GenderDemographicFilter);
        }

        /// <summary>
        /// Returns true if GenderDemographicFilter instances are equal
        /// </summary>
        /// <param name="input">Instance of GenderDemographicFilter to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GenderDemographicFilter input)
        {
            if (input == null)
            {
                return false;
