...
namespace LineOpenApi.MessagingApi.Model
{
    ...
    public partial class AreaDemographicFilter : DemographicFilter, IEquatable<AreaDemographicFilter>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as AreaDemographicFilter);
        }

        /// <summary>
        /// Returns true if AreaDemographicFilter instances are equal
        /// </summary>
        /// <param name="input">Instance of AreaDemographicFilter to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AreaDemographicFilter input)
        {
            if (input == null)
            {
                return false;
