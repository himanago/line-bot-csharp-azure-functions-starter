...
namespace LineOpenApi.MessagingApi.Model
{
    ...
    public partial class FlexCarousel : FlexContainer, IEquatable<FlexCarousel>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as FlexCarousel);
        }

        /// <summary>
        /// Returns true if FlexCarousel instances are equal
        /// </summary>
        /// <param name="input">Instance of FlexCarousel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FlexCarousel input)
        {
            if (input == null)
            {
                return false;
