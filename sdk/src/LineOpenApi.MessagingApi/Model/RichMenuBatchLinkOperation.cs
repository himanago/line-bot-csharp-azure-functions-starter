...
namespace LineOpenApi.MessagingApi.Model
{
    ...
    public partial class RichMenuBatchLinkOperation : RichMenuBatchOperation, IEquatable<RichMenuBatchLinkOperation>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as RichMenuBatchLinkOperation);
        }

        /// <summary>
        /// Returns true if RichMenuBatchLinkOperation instances are equal
        /// </summary>
        /// <param name="input">Instance of RichMenuBatchLinkOperation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RichMenuBatchLinkOperation input)
        {
            if (input == null)
            {
                return false;
