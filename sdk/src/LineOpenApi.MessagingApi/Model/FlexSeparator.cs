...
namespace LineOpenApi.MessagingApi.Model
{
    ...
    public partial class FlexSeparator : FlexComponent, IEquatable<FlexSeparator>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as FlexSeparator);
        }

        /// <summary>
        /// Returns true if FlexSeparator instances are equal
        /// </summary>
        /// <param name="input">Instance of FlexSeparator to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FlexSeparator input)
        {
            if (input == null)
            {
                return false;
